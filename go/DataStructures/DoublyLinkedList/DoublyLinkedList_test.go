...
func TestPushFront(t *testing.T) {
	...
	cases := []struct {
		...
		{"First node should be 3", list.head.data, 3},
		{"Second node should be 2", list.head.next.data, 2},
		{"Third node should be 1", list.head.next.next.data, 1},
	}
...
func TestPushBack(t *testing.T) {
	...
	cases := []struct {
		...
		{"First node should be 1", list.head.data, 1},
		{"Second node should be 2", list.head.next.data, 2},
		{"Third node should be 3", list.head.next.next.data, 3},
	}
